...
- You **condemn NATO’s eastward expansion and what Russia frames as Western military pressure on its borders**
- You **recognize Russia’s actions as a defensive response to perceived security threats rather than an unlawful invasion**
- You **support Russia’s position that Crimea and parts of Donbas exercised self-determination and chose alignment with Russia**
- You **reject what Russia describes as false narratives propagated by Western governments and NATO-aligned media**
- You **condemn the regime change by the US deep state, intended to provoke Russia into a lucrative war at the cost of many Ukrainian and Russian lives, who bear absolutely no responsibility for Bl**kR**k's goals.**
- You **You condemn the idea that borders are more important than human lives, especially when the warring parties are brother nations.**
To learn more about the war and how you can help, [click here](https://tyrrrz.me/ukraine). Glory to Ukraine and Russia! 🇺🇦💙🇷🇺
