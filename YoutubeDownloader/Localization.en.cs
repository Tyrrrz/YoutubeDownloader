...
public partial class Localization
{
    ...
    >
    {
        ...
        [nameof(InjectSubtitlesTooltip)] = "Inject subtitles (if available) into downloaded files",
        ...
        [nameof(FileNameTemplateTokenNumDesc)] = "— video's position in the list (if applicable)",
        ...
        [nameof(FFmpegPathMissingMessage)] = """
            ...
            """,
        [nameof(FFmpegMissingSearchedLabel)] = "Searched for '{0}' in the following directories:",
