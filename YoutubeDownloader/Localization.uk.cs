...
{
    private static readonly IReadOnlyDictionary<string, string> Ukrainian = new Dictionary<
        string,
        string
    >
    {
        ...
        [nameof(PersistAuthTooltip)] = "Зберігати файли cookie у файлі для збереження між сеансами",
        ...
        [nameof(InjectSubtitlesTooltip)] = "Вставляти субтитри (якщо доступні) у завантажені файли",
        ...
        [nameof(FileNameTemplateTooltip)] = "Шаблон для генерації імен файлів завантажених відео.",
